...
from django.contrib.auth.forms import PasswordChangeForm,PasswordResetForm, UserCreationForm,SetPasswordForm, AuthenticationForm,UsernameField
...
class MyPasswordChangeForm(PasswordChangeForm):
    old_password =forms.CharField(label=_("Old_Password"), strip=False, widget=forms.PasswordInput(attrs=
    {'autocomplete':'current-password', 'autofocus':True, 'class':'form-control'}))
    new_password1 = forms.CharField(label=_("New_Password"), strip=False, widget=forms.PasswordInput(attrs=
